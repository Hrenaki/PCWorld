...
namespace Core.OrderZone
{
   ...
   internal class OrderService : IOrderService
   {
      ...
      public Order? CreateOrder(Basket basket)
      {
         ...
         //
         //      var orderEntity = new EfOrderEntity()
         //      {
         ...
         //
         //      EfOrderProductEntity currentOrderProduct;
         //      List<EfOrderProductEntity> orderProducts = new List<EfOrderProductEntity>();
         //      foreach (var basketItem in basket.Items)
         //      {
         //         currentOrderProduct = new EfOrderProductEntity()
         //         {
